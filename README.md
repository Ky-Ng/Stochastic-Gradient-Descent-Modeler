...
- The main algorithm behind `Back Propogation` which enables Neural Networks to learn
- This codebase shows SGD in an relaxed context (finding the average of an array of numbers)
